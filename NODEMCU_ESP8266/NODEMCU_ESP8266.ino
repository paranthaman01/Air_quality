...
#define BLYNK_TEMPLATE_ID "TMPLqaUMC4Hx"
#define BLYNK_DEVICE_NAME "DHT 11"
#define BLYNK_AUTH_TOKEN "lkSpTQq8ryHY0eN9JqIPtCu3HIT4Oyl8"
...
const char* ssid = "REALME"; //--> Your wifi name or SSID.
const char* password = "234567890"; //--> Your wifi password.
//----------------------------------------
...
String GAS_ID = "AKfycbx5dzmyKmAaqypEydyPbvG4743lBn2UAQP_1ICAIbnSBM7lsLI2zZiKwA5JhGbNfa_C"; //--> spreadsheet script ID
